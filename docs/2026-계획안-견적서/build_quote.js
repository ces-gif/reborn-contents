...
const header = grid([4700, 1900, 3491], [
  ...
  R(L('유효기간', '발행일로부터 30일'), LBL('상        호'), ctr('(주)리본마켓', { bold: true })),
  ...
  R(L('지급방법', '계산서 발행'), LBL('주        소'), ctr('경기도 평택시 이충로 49-29')),
  R(L('행사장소', '한국항공대학교 대강당 및 스타트업 라운지'), LBL('담  당  자'), ctr('최은성   010-5843-0627')),
]);
