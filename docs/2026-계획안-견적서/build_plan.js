...
const 예산 = [
  ...
  O('(전문가 활용비) 3,500,000원'),
  D('특강 강사료 500,000원 × 1명 = 500,000원'),
  ...
  O('(일반관리비 및 이윤) 290,909원'),
  O('(부 가 세) 909,091원'),
  P('', { after: 100 }),
  table([2700, 1900, 1450, 3589], [
    R('구 분', '금액(원)', '구성비', '비 고'),
    R('전문가 활용비', { t: '3,500,000', align: AlignmentType.RIGHT }, ctr('35.0%'), '강사료·멘토링비·평가료·심사수당'),
    ...
    R('일반관리비 및 이윤', { t: '290,909', align: AlignmentType.RIGHT }, ctr('2.9%'), '지방계약법 시행규칙 제8조'),
  ...
  callout('※ 2025년 대비 예산은 3,000,000원 줄었으나 경진대회와 시상금 2,500,000원이 새로 포함되었다. 이에 따라 일반관리비(2.0%)와 이윤(1.28%)이 지방계약법 시행규칙상 한도(각 8%, 10%)를 크게 밑돈다. 상세 산출 근거는 별첨 원가계산서를 참조한다.'),
];
