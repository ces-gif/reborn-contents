...
const 개요 = [
  H('특강 및 경진대회 개요'),
  O('(개최목적) 급변하는 AI 시대에 창업가로서 필요한 지식과 역량을 기르되, 기획안에 머무르지 않고 AI 코딩 도구로 직접 동작하는 시제품(프로토타입)을 만들어 보게 함으로써 고양시·경기북부 대학(원)생의 AI 기술 창업 경쟁력을 강화함'),
  O('(일    시)'),
  ...
  O('(운    영) (주)리본마켓'),
  O('(대    상) 고양시 및 경기북부에 거주하는 대학교(대학원 포함) 재학생 (개인 또는 1~4인 팀)'),
...
const 특강 = [
  ...
  H('특강 세부 계획(안) : 대강당'),
  O('(개최목적) 고양시·경기북부 대학(원)생이 AI 코딩 도구를 활용해 자기 아이디어를 직접 프로토타입으로 구현해 보도록 하여, 비전공자도 제품을 만들 수 있다는 경험을 제공함'),
