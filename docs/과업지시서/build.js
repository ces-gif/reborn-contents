...
const s1 = [
  ...
  bullet('참가 대상 : 고양시 및 경기북부에 거주하는 대학교(대학원 포함) 재학생 (개인 또는 1~4인 팀)'),
...
const s3 = [
  ...
  bullet('강사 섭외 : 「바이브 코딩을 활용한 1인 창업」 및 「AI 코딩 도구로 만드는 MVP」를 주제로 실무 경험을 갖춘 외부 전문 강사를 섭외하여 특강(2시간 기준)을 진행한다. 강사료는 발주처의 「강사수당 지급기준」 나급(최초 1시간 170,000원, 초과 매시간 80,000원)을 적용한다.'),
  ...
  bullet('대상 : 경진대회 참가 희망자 전체 및 바이브 코딩·AI 창업에 관심 있는 고양시·경기북부 거주 대학(원)생 누구나 참여할 수 있도록 운영한다. (정원 60명 내외)'),
...
const s4 = [
  ...
  table([1750, 2200, 3604, 1800], [
    ...
    R({ t: '전문가 활용비', ...VM }, '창업 특강 강사료', '강사수당 지급기준 나급 · 2시간 (170,000원 + 80,000원)', won('250,000')),
    ...
    R({ t: '행사 운영비 및 일반관리비', bold: true, align: AlignmentType.CENTER }, '식대/운영/대행수수료', '당일 식대·다과, 소모품, 현장 운영 인력 및 대행 수수료 (기념품 제외)', won('2,050,000')),
  ...
  callout('※ 원 과업지시서 대비 조정 내역 — ① 장려상 단가(200,000원 → 100,000원)와 결승 심사수당(500,000원 → 400,000원)을 조정하고 참가자 기념품 항목을 제외하여 1,700,000원을 확보하여, 「실습 환경비」 신설·증액(+1,200,000원)과 1:1 창업 멘토링비 증액(팀당 100,000원 → 150,000원, +500,000원)에 재배분하였다. ② 창업 특강 강사료는 발주처 「강사수당 지급기준」 나급(2시간 250,000원)에 맞추어 500,000원에서 250,000원으로 조정하고, 차액 250,000원은 「행사 운영비 및 일반관리비」로 이전하였다. ③ 총 예산 10,000,000원(부가가치세 포함)은 변동이 없다.'),
  noticeBox('※ 본 예산 배분은 협의용 초안이며, 발주처와의 협의를 거쳐 확정합니다.'),

  // 예산표에 '나급 적용'만 적으면 근거를 확인할 수 없어 등급표를 함께 싣는다.
  // 등급표가 쪽을 걸치면 등급 일부만 보이므로 새 쪽에서 시작한다
  PB(),
  P('◇ 참고 — 강사수당 지급기준 (발주처 기준)', { bold: true, before: 0, after: 140, size: 22 }),
  table([1100, 3954, 1400, 1400, 1500], [
    R('등급', '적용대상 (요약)', '최초 1시간', '초과 매시간', '2시간 환산'),
    R(ctr('특1급'), '전직 장관(급)·광역자치단체장, 전직 국회의원, 대기업 총수(부회장 이상)', won('400,000'), won('300,000'), won('700,000')),
    R(ctr('특2급'), '전직 차관(급)·기초자치단체장, 대기업 임원, 중견기업 대표', won('300,000'), won('200,000'), won('500,000')),
    R(ctr('가급'), '전직 4급 이상 공무원, 전직 대학의 교수(조교수 이상), 중소기업 대표, 전문직 3년 이상 실무경력자', won('280,000'), won('120,000'), won('400,000')),
    R({ t: '나급', bold: true, fill: 'FFF2CC', align: AlignmentType.CENTER },
      { t: '전직 5급(상당) 공무원, 중견기업 부장(급)·중소기업 임원, 국가전문자격증 보유 3년 이상 실무경력자', bold: true, fill: 'FFF2CC' },
    ...
    R(ctr('다급'), '전직 6급 이하 공무원, 외국어·전산 등 강사', won('100,000'), won('50,000'), won('150,000')),
  ...
  P('※ 본 과업의 창업 특강(2시간)은 나급을 적용하여 170,000원 + 80,000원 = 250,000원으로 계상하였다. 2025년 용역도 동일하게 나급을 적용하였다(4시간 410,000원, 3시간 330,000원). 강사가 중소기업 대표 등 가급 요건에 해당할 경우 2시간 400,000원까지 적용할 수 있다.',
    { before: 140, size: 18 }),
];
